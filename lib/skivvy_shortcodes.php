...
class skivdiv_chunks {
	...
	public function __construct(){
		...
		foreach( $tags as $tag ) {
			add_shortcode( $tag,	'skivdiv_chunks::shortcode_skiv_div' );
		}
		add_shortcode( 'lorem', 	'skivdiv_chunks::shortcode_loremipsum' );
		add_shortcode( 'bloginfo',	'skivdiv_chunks::shortcode_bloginfo' );
		add_shortcode( 'clearall',	'skivdiv_chunks::shortcode_clearall' );
		add_shortcode( 'newsfeed',	'skivdiv_chunks::shortcode_newsfeed' );
	}
	...
	// [newsfeed]- 25Feb15
		public function shortcode_newsfeed( $atts ) {
	...
	// [clearall] - 25Feb15
		public function shortcode_clearall() {
	...
	// [bloginfo] - 25Feb15
		public function shortcode_bloginfo( $atts ) {
			extract(shortcode_atts(array(
				'key' => '',
			), $atts));
	...
	/// [lorem] - 25Feb15
		public function shortcode_loremipsum ( $atts ) {
			extract( shortcode_atts( array(
					'words' => 55
				), $atts ) );
